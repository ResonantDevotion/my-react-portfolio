        ...
        <CardGroup>
            <Card border="light" style={{ width: '18rem' }}>
                ...
                <Card.Body>
                    ...
                    <Button variant="outline-warning">Git to my Github</Button>{' '}
                </Card.Body>
            </Card>
            <Card border="light" style={{ width: '18rem' }}>
                <Card.Header className="iconBox">
                ...
                <Card.Body>
                    ...
                    <Button variant="outline-warning">Link to my LinkedIn</Button>{' '}
                </Card.Body>
            </Card>
            <Card border="light" style={{ width: '18rem' }}>
                <Card.Header className="iconBox">
                ...
                <Card.Body>
                    ...
                    <Button variant="outline-warning">Sail to my gmail</Button>{' '}
                </Card.Body>
            </Card>
        </CardGroup >
    );
